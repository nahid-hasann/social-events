...
const router = createBrowserRouter([
  ...
  {
    path: 'dashboard',
    element: <Dashboard></Dashboard>, // ১. এখানে প্রাইভেট রাউট র‍্যাপ করতে হবে পরে
    children: [
      {
        path: 'user-home', // লিংক: /dashboard/user-home
        element: <div>User Home / Charts here</div> // ২. পরে এখানে কম্পোনেন্ট বসাবো
      },
      {
        path: 'add-event',
