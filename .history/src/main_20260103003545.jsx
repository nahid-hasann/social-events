...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      // লক্ষ্য করুন: আমি এখান থেকে create-event, joined, manage-events সরিয়ে দিয়েছি।
      // কারণ এগুলো এখন Dashboard এর ভেতরে থাকবে।
    ],
  },
  ...
  {
    path: 'dashboard',
    // ১. পুরো ড্যাশবোর্ডকে প্রাইভেট করে দিলাম
    ...
    children: [
      ...
      {
        path: 'add-event', // Link: /dashboard/add-event
        element: <CreateEvent></CreateEvent>
      },
      {
        path: 'my-events', // Link: /dashboard/my-events (এখানে ManageEvents দিলাম)
        element: <ManageEvents></ManageEvents>
      },
      {
        path: 'joined-events', // Link: /dashboard/joined-events (এখানে JoinEvents দিলাম)
