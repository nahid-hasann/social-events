...
import { toast } from 'react-toastify'; // ToastContainer দরকার নেই যদি App.js এ থাকে
import { AuthContext } from '../../AuthProvidor'; // পাথ ঠিক রেখো
...
const Login = () => {
    ...
    // --- Demo Login Function Added Here ---
    const handleDemoLogin = () => {
        const demoEmail = "guest@demo.com"; // অবশ্যই ফায়ারবেসে এই ইউজার থাকতে হবে
