        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <section className="my-16 text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                        ...
                        <div
                            key={i}
                            className="p-6 border rounded-lg shadow hover:shadow-lg transition bg-white flex flex-col items-center"
                        >
            ...
            <section className="my-16">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                    {[
                        "https://i.ibb.co/vZsR5RL/tree-plantation.jpg",
                        "https://i.ibb.co/k3ycqFm/cleanup.jpg",
                        "https://i.ibb.co/vJ0sCsh/donation.jpg",
                        "https://i.ibb.co/2F8sbbG/community.jpg",
                        "https://i.ibb.co/hLPSddv/environment.jpg",
                        "https://i.ibb.co/fHqWbXj/road-cleaning.jpg",
                    ].map((src, i) => (
                        <img
                            key={i}
                            src={src}
