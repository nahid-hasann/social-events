...
const Home = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-x-hidden">
            {/* Hero Section */}
            <section className="relative flex flex-col justify-center items-center text-center text-white rounded-xl overflow-hidden my-10 shadow-lg">
                <img
                ...
                />
                <div className="relative z-10 py-20 sm:py-28 md:py-40 px-4">
                    <motion.h1
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="mt-6 bg-blue-600 hover:bg-blue-700 px-6 py-2 sm:px-8 sm:py-3 rounded-lg text-sm sm:text-base font-semibold transition shadow-lg"
                    >
                        Explore Events
                    </motion.button>
                </div>
            ...
            <section className="my-16 text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                        { title: "Create Events", text: "Organize social activities and inspire others.", icon: "🌱" },
                        { title: "Join Activities", text: "Participate in cleanup, donation, or plantation programs.", icon: "🤝" },
                        { title: "Track Progress", text: "Stay updated with local community projects.", icon: "📊" },
                    ].map((item, i) => (
                        <motion.div
                            key={i}
                            whileHover={{ y: -5 }}
                            className="p-6 border rounded-lg shadow hover:shadow-lg transition bg-white dark:bg-gray-800 dark:border-gray-700 dark:text-white flex flex-col items-center"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {REVIEWS.map((item, idx) => (
                            ...
                            >
                                ...
                                <p className="text-gray-600 dark:text-gray-300 mb-6 italic z-10">"{item.review}"</p>
                                <div className="mt-auto flex items-center gap-4">
                                    <img src={item.img} alt={item.name} className="w-12 h-12 rounded-full border-2 border-blue-500 object-cover" />
                                    <div>
            ...
            <section className="my-20 max-w-4xl mx-auto px-4">
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">Got questions? We have got answers.</p>
                </div>

                <div className="space-y-4">
                    {FAQS.map((faq, idx) => (
                        <div key={idx} className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden shadow-sm bg-white dark:bg-gray-800">
                            <button
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                    {GALLERY_IMAGES.map((src, i) => (
                        <motion.img
                            ...
                            src={src}
                            alt={`gallery-${i}`}
                            className="rounded-lg w-full h-40 sm:h-48 md:h-56 object-cover hover:scale-105 transition-transform shadow-md"
                        />
                    ))}
                </div>
            </section>
            ...
            {/* Newsletter Section */}
            <section className="my-20 bg-blue-50 dark:bg-gray-800 p-6 sm:p-10 rounded-lg text-center shadow-inner">
                <h2 className="text-2xl text-gray-800 dark:text-white sm:text-3xl font-bold mb-3">
                    Subscribe to Our Newsletter
                </h2>
                <p className="text-gray-600 dark:text-gray-300 mb-6 max-w-xl mx-auto">
                    Get updates on upcoming community events and volunteering opportunities.
                </p>
                <form onSubmit={(e) => e.preventDefault()} className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-0">
                    <input
                        type="email"
                        placeholder="Enter your email"
                        className="border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg sm:rounded-l-lg p-3 w-full sm:w-64 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    <button className="bg-blue-600 text-white px-6 py-3 sm:rounded-r-lg rounded-lg sm:rounded-l-none w-full sm:w-auto font-medium hover:bg-blue-700 transition shadow-lg">
                        Subscribe
                    </button>
                </form>
            </section>
