...
const ManageUsers = () => {
    // আপাতত ডামি ডাটা দিয়ে ডিজাইন করছি, পরে ডাটাবেস থেকে আনবো
    const [users, setUsers] = useState([]);

    // TODO: এখানে useEffect দিয়ে ডাটাবেস থেকে সব ইউজার লোড করতে হবে
    // আপাতত ডামি ডাটা সেট করছি বোঝার জন্য
    useEffect(() => {
        setUsers([
    ...
    const handleMakeAdmin = (user) => {
        // TODO: ব্যাকএন্ডে API কল করে রোল আপডেট করতে হবে
