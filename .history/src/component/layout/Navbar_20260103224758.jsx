...
import { FaBars, FaTimes } from 'react-icons/fa'; // হ্যামবার্গার আইকন ইম্পোর্ট
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="md:hidden flex items-center gap-4">
                        <ThemeToggle /> {/* মোবাইলেও থিম চেঞ্জ অপশন রাখা হলো */}
                        <button
                            onClick={toggleMenu}
                            ...
                            {user ? (
                                <div className="flex flex-col gap-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        />
                                        <span className="text-gray-800 dark:text-white font-medium">{user?.displayName}</span>
                                    </div>
                                    <button
