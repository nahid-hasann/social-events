                    ...
                    {user ? (
                        <>
                            <div className="relative group">
                                ...
                                />
                                <span className="absolute transition-all duration-300 ease-out group-hover:translate-y-0 translate-y-2 left-1/2 -translate-x-1/2 -top-[25px] bg-gray-800 text-white text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100  whitespace-nowrap">
                                    {user?.displayName || "User"}
                                </span>
                                <div className="absolute transition-all opacity-0 duration-300 ease-out group-hover:translate-y-0 group-hover:opacity-100 translate-y-2 -right-20 mt-0 w-48 bg-white shadow rounded hidden group-hover:block">
