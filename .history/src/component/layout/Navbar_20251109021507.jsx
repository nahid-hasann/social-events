                        ...
                        {user ? (
                            <>
                                ...
                                <div className="relative group">
                                    ...
                                    />
                                    <span className="absolute left-[-17px] top-[30px]  bg-gray-800 text-white text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition whitespace-nowrap">
