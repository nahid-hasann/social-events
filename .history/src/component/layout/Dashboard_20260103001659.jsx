...
const Dashboard = () => {
    // TODO: পরবর্তীতে আমরা এখানেisAdmin চেক করবো হুক দিয়ে
    const isAdmin = false; // আপাতত false দিয়ে রাখলাম, true দিলে এডমিন মেনু দেখাবে
    ...
    return (
        <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <div className="flex-1 overflow-y-auto p-8">
                <Outlet></Outlet> {/* এখানে সব পেজ লোড হবে */}
            </div>
        </div>
    );
};
