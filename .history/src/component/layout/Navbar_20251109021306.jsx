                        ...
                        {user ? (
                            <>
                                ...
                                <div className="relative group">
                                    ...
                                    />
                                    <span className="absolute top-[-10px] bottom-11 left-1/2 transform  bg-gray-800 text-white text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition whitespace-nowrap">
