                    ...
                    {user ? (
                        <>
                            <div className="relative group">
                                ...
                                />
                                <span className="absolute left-1/2 -translate-x-1/2 -top-[25px] bg-gray-800 text-white text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition whitespace-nowrap">
                                    {user?.displayName || "User"}
                                </span>
                                <div className="absolute duration-700 transition-all ease-out -right-20 mt-0 w-48 bg-white shadow rounded hidden group-hover:block">
